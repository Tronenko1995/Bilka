<?php
/**
 * Webasyst modified shopCart class
 *
 * Class BistrozakazCart
 */
class shopBistrozakazCart
{
    const COOKIE_KEY = 'bistrozakaz_cart';
    protected $code;
    /**
    ...
    {
        $data = wa()->getStorage()->get('bistrozakaz/cart');
    ...
    {
        $data = wa()->getStorage()->get('bistrozakaz/cart', array());
        $data[$key] = $value;
        wa()->getStorage()->set('bistrozakaz/cart', $data);
    }

    protected function clearSessionData()
    {
        wa()->getStorage()->remove('bistrozakaz/cart');
    }
