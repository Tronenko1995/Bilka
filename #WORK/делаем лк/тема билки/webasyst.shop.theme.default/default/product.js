    ...
    this.form.find(".sku-feature").change(function () {
        ...
        if (sku) {
            ...
            if (sku.available) {
                ...
                self.form.find("div.stocks span").hide();
...
Product.prototype.updateSkuServices = function (sku_id) {
    this.form.find(".nalichie").hide();
    this.form.find(".sku-no-stock").hide();
...
$(function () {
    ...
    const prodGal = $('#product-gallery .image').first();
    console.log(prodGal);
    //prodGal.trigger("click");
    // prodGal.addClass( "selected" );
    const prodArr = Array.from(prodGal);
    // console.log(prodArr.reverse());
